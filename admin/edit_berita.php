                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <?php 
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $isi['id_berita']; ?></td>
                                                        <td><?php echo $isi['judul']; ?></td>
                                                        
                                                        <td><?php echo $isi['isi']; ?></td>
                                                        
                                                       <td>
                                                        <a href='form_edit_berita.php?id=<?=$isi['id_berita']?>' class="btn btn-success">Edit</a></td>
                                                       <td> <a href='aksi_hapus_berita.php?id=<?=$isi['id_berita']?>' class="btn btn-danger">Delete</a>
                                                    </td> 
                                                    </tr>
                                                    <?php
                                                    }
