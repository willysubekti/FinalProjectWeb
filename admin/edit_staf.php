                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Edit Staf</h2>
                                        ...
                                        <table class="table">
                                            <thead class="bg-light">
                                                <tr class="border-0">
                                                    ...
                                                    <th class="border-0">Nama Staf</th>
                                            ...
                                            <tbody>
                                                ...
                                                <?php 
                                                        require "connect.php";
                                                        $no = 1;
                                                        $data = mysqli_query($connect, "SELECT * FROM staf");
                                                        while($isi = mysqli_fetch_array($data))
                                                        {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $isi['id_staf']; ?></td>
                                                        <td><?php echo $isi['nama_staf']; ?></td>
                                                        
                                                        <td><?php echo $isi['notelp']; ?></td>
                                                        <td><?php echo $isi['alamat']; ?></td>
                                                       <td>
                                                        <a href='form_edit_staf.php?id=<?=$isi['id_staf']?>' class="btn btn-success">Edit</a></td>
                                                       <td> <a href='aksi_hapus_staf.php?id=<?=$isi['id_staf']?>' class="btn btn-danger">Delete</a>
                                                    </td> 
                                                    </tr>
                                                    <?php
                                                    }
