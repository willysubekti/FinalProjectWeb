                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Edit Berita</a></li>
	                                ...
	                                ?>
                                        <form action="aksi_edit_berita.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                ...
                                                <input id="id" readonly type="text" class="form-control" name="id_berita" value="<?php echo $data['id_berita'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="judul" class="col-form-label">Judul</label>
                                                <input id="judul" type="text" class="form-control" name="judul" value="<?php echo $data['judul'] ?>">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="isi" class="col-form-label">Isi Berita</label>
                                                <input id="isi" type="text" class="form-control" name="isi" value="<?php echo $data['isi'] ?>">
                                            </div>
