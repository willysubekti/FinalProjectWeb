                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <?php 
	                                    include "connect.php";
	                                   $edit = mysqli_query($connect,"SELECT * FROM staf WHERE id_staf='$_GET[id]'");
                                       $data    = mysqli_fetch_array($edit);{
	                                ?>
                                        <form action="aksi_edit_staf.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="id" class="col-form-label">Id</label>
                                                <input id="id" readonly type="text" class="form-control" name="id_staf" value="<?php echo $data['id_staf'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="nama_staf" class="col-form-label">Nama Staf</label>
                                                <input id="nama_staf" type="text" class="form-control" name="nama_staf" value="<?php echo $data['nama_staf'] ?>">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="notelp" class="col-form-label">Nomor Telepon</label>
                                                <input id="notelp" type="text" class="form-control" name="notelp" value="<?php echo $data['notelp'] ?>">
                                            </div>
                                            <div class="form-group">
