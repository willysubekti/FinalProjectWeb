                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Tambah Prodak</h2>
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="index.php" class="breadcrumb-link">Dashboard</a></li>
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Add List</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">Tambah Prodak</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Tambah Prodak</h3>
                                </div>
                                <div class="card">
                                    <h5 class="card-header">Tambah Prodak</h5>
                                    <div class="card-body">
                                        <form action="aksi_tambah_prodak.php" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="id" class="col-form-label">ID</label>
                                                <input type="text" class="form-control" name="id_prodak">
                                            </div>
                                            <div class="form-group">
                                                <label for="nama_prodak" class="col-form-label">Nama Prodak</label>
                                                <input type="text" class="form-control" name="nama_prodak">
                                            </div>
