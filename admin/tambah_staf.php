                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="tambah_berita">Tambah Berita</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="edit-movie.php">Edit Staf</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="edit-news.php">Edit Prodak</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="edit-news.php">Edit Berita</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Tambah Staf</h2>
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="index.php" class="breadcrumb-link">Dashboard</a></li>
                                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Tambah Staf</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Tambah Staf</h3>
                                </div>
                                <div class="card">
                                    <h5 class="card-header">Tambah Staf</h5>
                                    <div class="card-body">
                                        <form action="aksi_tambah_staf.php" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="id" class="col-form-label">ID</label>
                                                <input type="text" class="form-control" name="id_staf">
                                            </div>
                                            <div class="form-group">
                                                <label for="nama_staf" class="col-form-label">Nama Staf</label>
                                                <input type="text" class="form-control" name="nama_staf">
                                            </div>
