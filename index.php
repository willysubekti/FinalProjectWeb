...
<body class="biru-tua">
	<div class="skl-banner">
		...
		<div class="col-md-6  txt-kanan">
			<p>
				<a href="pages/index.html" class="txt-putih"> <i class="fa fa-home"></i>&nbsp;Home</a>&nbsp;|  
				<a href="pages/form.php" class="txt-putih"> <i class="fa fa-user"></i>&nbsp;Login</a>
			</p>
			...
			<nav class="navbar navbar-default biru-muda skl-shadow" role="navigation">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a href="index.html" class="navbar-brand active txt-putih"><i class="fa fa-home"></i>&nbsp;Home</a>
					</div>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav ">
							...
							<li><a href="pages/staff.php"><i class="fa  fa-user ">&nbsp;</i>Staff Vaporista</a></li>
							<li><a href="pages/produk.php"><i class="fa  fa-group ">&nbsp;</i>Daftar Produk</a></li>
	...
	<div class="bg-putih skl-radius skl-shadow">
		...
		<div class="col-md-6">
			<div class="col-md-4 merah skl-radius-ats  txt-putih ">Informasi Berita</div>
			...
			<div class="skl-content garis">
				<div class="row">
					...
					<div class="col-md-8 ">
						<center><p><b><a href="#"><?php echo $isi['judul']; ?> </a></b></br></p></center>
						<p>
							<?php echo $isi['isi']; ?>
		...
		<div class="bg-putih skl-radius skl-shadow bts-atas">
			<div class="col-md-3">
				...
				<div class="skl-content">
					<div class="row">
						<div >
							<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1662.2558257288956!2d110.38705432272876!3d-7.733156187501409!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xc1a69767d95e8f22!2sDISTRICT+VAPESHOP!5e0!3m2!1sid!2sid!4v1546195492304" width="250" height="150" frameborder="0" style="border:0" allowfullscreen></iframe>
