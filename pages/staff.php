	...
	<div class="col-md-12">
		<div class="skl-banner">
			...
			<div class="sambungfloat"></div>
				...
				<div class="col-md-6">
					<div class="col-md-4 merah skl-radius-ats  txt-putih ">VAPORISTA</div>
					...
					<div class="col-md-8 skl-content "></div>
						...
						<div class="skl-content garis">
							<center><p><b><a href="#"><?php echo $isi['nama_staf']; ?> </a></b></br></p></center>
						<p>
							Nomor Telopon :<?php echo $isi['notelp']; ?><br>
							Alamat :<?php echo $isi['alamat']; ?>
